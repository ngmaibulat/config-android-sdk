...
- get-serialno
- backup -all
- restore /path/to/backupflile.adb
- bugreport

### Package Manager

- List enabled packages: `pm list packages -e`
- List disabled packages: `pm list packages -d`
- List 3rd party packages, installed by user: `pm list packages -3`

### Users

- List users: `pm list users`
- Groups: `pm list permission-groups`

### Features

- List features: `pm list features`
